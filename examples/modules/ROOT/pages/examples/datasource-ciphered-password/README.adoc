...
The configuration is simply a datasource configuration with an additionnal parameter "PasswordCipher" to specify the encryption to use.
...
For more information please see the http://openejb.apache.org/3.0/datasource-password-encryption.html[documentation]
