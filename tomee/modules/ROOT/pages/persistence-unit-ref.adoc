= persistence-unit-ref Both lookup and injection of an EntityManagerFactory can be configured via the @PersistenceUnit annotation or +++<persistence-unit-ref>+++in xml.
