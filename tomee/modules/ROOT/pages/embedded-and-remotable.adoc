...
_The source for this example is in the "telephone-stateful" directory located in the xref:{common-vc}::download-ng.adoc[openejb-examples.zip]  available on the http://tomee.apache.org/downloads.html[download page]._
...
In the "telephone-stateful" directory of the xref:{common-vc}::download-ng.adoc[examples zip] , just run:
