...
_The source for this example is in the "telephone-stateful" directory located in the link:openejb:download.html[openejb-examples.zip]  available on the http://tomee.apache.org/downloads.html[download page]._
...
In the "telephone-stateful" directory of the link:openejb:download.html[examples zip] , just run:
