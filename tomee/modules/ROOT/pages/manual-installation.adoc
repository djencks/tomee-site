...
Tomcat contains an old non-compliant version of the {ee-prefix}.annotation classes and these invalid classes must be updated so OpenEJB can process annotations.
