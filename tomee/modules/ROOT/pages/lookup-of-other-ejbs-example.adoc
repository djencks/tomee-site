...
[source,xml]
----
include::{examples-vc}::examples$lookup-of-ejbs/src/main/resources/META-INF/ejb-jar.xml
----
...
----
include::{examples-vc}::examples$lookup-of-ejbs/src/test/java/org/superbiz/ejblookup/EjbDependencyTest.java
----

== Running

Running the example is fairly simple.
In the "lookup-of-ejbs" directory of the xref:{common-vc}::download-ng.adoc[examples zip] , just run:
