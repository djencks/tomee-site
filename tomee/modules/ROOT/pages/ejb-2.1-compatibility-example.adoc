...
Namely, you had to have a "home" interface that extended {ee-prefix}.ejb.EJBHome or {ee-prefix}.ejb.EJBLocalHome.
This interface served as a sort of factory to create your bean's interface which itself had to extend either {ee-prefix}.ejb.EJBObject or {ee-prefix}.ejb.EJBLocalObject.
...
import {ee-prefix}.ejb.Init;
import {ee-prefix}.ejb.Local;
import {ee-prefix}.ejb.LocalHome;
import {ee-prefix}.ejb.Remote;
import {ee-prefix}.ejb.RemoteHome;
import {ee-prefix}.ejb.Remove;
 ...
 * it does not need to implement {ee-prefix}.ejb.SessionBean
 *
...
import {ee-prefix}.ejb.CreateException;
import {ee-prefix}.ejb.EJBHome;
...
import {ee-prefix}.ejb.CreateException;
import {ee-prefix}.ejb.EJBLocalHome;
import java.rmi.RemoteException;
...
import {ee-prefix}.ejb.EJBLocalObject;
...
import {ee-prefix}.ejb.EJBObject;
import java.rmi.RemoteException;
